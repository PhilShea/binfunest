...
You can install the development version of `binfunest` from [GitHub](https://github.com/) with:
...
```{r plotQab, fig.cap="Note all samples above 19 dB SNR returned zero.  The Estimated line is dashed so the 3 dB + Offset line, which it overlays, is visible."}
