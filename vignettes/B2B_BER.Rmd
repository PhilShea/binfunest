...
The covariance indicates that there is a relationship between the two parameters.  It is, correlation matrix can be computed as follows (we make a function as we'll find it useful):
