...
A correlation of `r cor.mle( mle3)[1,1]` is rather large. The same result can be reached easier with this package's `mleB2B` function, which facilitates the data being hosted in a data frame or list:
